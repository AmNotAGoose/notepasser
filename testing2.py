...
class Peer2:
    def __init__(self, network_manager, user_manager: UserManager, conn, addr, my_sign: SigningKey, get_trusted_token):
        ...
        payload = {
            ...
            "trusted_token_exists": bool(self.my_information.get("trusted_token"))
        }
    ...
    def start_token_request(self):
        ...
        self.conn.sendall(self.box.encrypt(json.dumps(payload).encode()))

        self.resolve_trusted_state()

    def reload_user_information(self):
        self.my_information = self.user_manager.get_user(self.my_information.get("verify_key")).serialize()
